...
ST7735_IO_t st7735_pIO = {
	lcd_init,
	NULL,
	0,  // Address is uint16_t, not a pointer
	lcd_writereg,
	lcd_readreg,
	lcd_senddata,
	lcd_recvdata,
...
// Function to clear a specific line of text on the LCD
...
//	#endif
	...
	ST7735_LCD_Driver.FillRect(&st7735_pObj, 0, 0, ST7735Ctx.Width, ST7735Ctx.Height, 0x0000);
...
//	ST7735_LCD_Driver.DrawBitmap(&st7735_pObj,0,0,WeActStudiologo_160_80);
	...
	LCD_ShowString(82, 40, 160, 16, 16, text);
...
//	sprintf((char *)&text, "LCD ID:0x%X", st7735_id);
	// sprintf((char *)&text, "Systems Initialized Bitch! :D");
